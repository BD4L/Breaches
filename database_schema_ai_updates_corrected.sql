-- AI Agent System Database Schema Updates (CORRECTED)
...
-- ============================================================================
-- 2. CREATE AI REPORT USAGE TRACKING TABLE
-- ============================================================================
...
-- Test the setup
SELECT 'research_jobs table created' as status;
SELECT 'ai_report_usage table created' as status;
SELECT 'Helper functions created' as status;
SELECT 'Views and triggers created' as status;

-- Test rate limiting function
SELECT check_daily_rate_limit('00000000-0000-0000-0000-000000000000', 10) as rate_limit_test;
